...
webserver1_ip_PRIVATE=$(terraform output -raw webserver1_ip_PRIVATE)
webserver2_ip_PRIVATE=$(terraform output -raw webserver2_ip_PRIVATE)
...
[webserver]
webserver1 ansible_host=${webserver1_ip} ansible_user=jack ansible_ssh_private_key_file=~/.ssh/cc2-tf-ans-key-3.pem nginx_ip=${webserver1_ip_PRIVATE}
webserver2 ansible_host=${webserver2_ip} ansible_user=jack ansible_ssh_private_key_file=~/.ssh/cc2-tf-ans-key-3.pem nginx_ip=${webserver2_ip_PRIVATE}
